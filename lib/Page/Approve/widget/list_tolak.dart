...
class ListTolak extends StatefulWidget {
  final int id;
  final List listProgress;
  const ListTolak({super.key, required this.listProgress, required this.id});

  @override
  State<ListTolak> createState() => _ListTolakState();
}

class _ListTolakState extends State<ListTolak> {
